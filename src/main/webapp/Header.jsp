        ...
        <header class="navbar navbar-expand-lg navbar-light custom-header" >
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="recursos/imagenes/logomiskida.jpeg" alt="Logo de la empresa" width="40" height="40" class="d-inline-block align-top">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="AgregarInsumoPasos.jsp">+ Nueva Receta</a>
                        </li>
                        <li class="nav-item">
